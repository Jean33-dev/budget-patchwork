...
interface MultiTransferOptionsProps {
  envelope: BudgetEnvelope;
  otherEnvelopes: BudgetEnvelope[];
  onMultiTransferChange: (transfers: { targetId: string; targetTitle: string; amount: number }[]) => void;
}

export const MultiTransferOptions = ({
  envelope,
  otherEnvelopes,
  onMultiTransferChange
}: MultiTransferOptionsProps) => {
  ...
  const handleAddMultiTransfer = () => {
    ...
    onMultiTransferChange(updatedTransfers);
  };
