 ...
 * 1. Créez un nouvel objet avec vos paires clé/valeur (e.g. ptTranslations).
 * 2. Ajoutez { value: "pt", label: "Português" } à supportedLanguages.
 * 3. Ajoutez-le dans l'objet translations ci-dessous.
 */
