const itTranslations: Record<string, string> = {
  ...
  "categories.title": "Gestione Categorie",
  "categories.subtitle": "Organizza e traccia le tue spese per categoria",
  "categories.back": "Indietro",
  "categories.tabs.categories": "Categorie",
  "categories.tabs.assignments": "Assegnazioni",
  "categories.card.budgetsAssigned": "Budget associati",
  "categories.card.noBudgetsAssigned": "Nessun budget assegnato",
  "categories.card.totalBudget": "Budget totale",
  "categories.card.expenses": "Spese",
  "categories.card.remaining": "Rimanente",
  "categories.card.progression": "Progressione",
  "categories.assignment.assignBudget": "Assegna un budget",
  "categories.assignment.selectBudget": "Seleziona un budget",
  "categories.assignment.allBudgetsAssigned": "Tutti i budget disponibili sono già stati assegnati.",
  "categories.assignment.currentlyAssigned": "Budget attualmente assegnati:",
  "categories.assignment.noBudgetAssigned": "Nessun budget assegnato",
  "categories.edit.title": "Modifica categoria",
  "categories.edit.nameLabel": "Nome categoria",
  "categories.edit.namePlaceholder": "Inserisci il nome della categoria",
  "categories.edit.cancel": "Annulla",
  "categories.edit.save": "Salva",
  "categories.toast.errorTitle": "Errore",
  "categories.toast.errorLoadBudgets": "Impossibile caricare i budget",
  "categories.toast.errorAssignBudget": "Impossibile assegnare il budget",
  "categories.toast.errorRemoveBudget": "Impossibile rimuovere il budget",
